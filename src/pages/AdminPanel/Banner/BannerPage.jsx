            ...
            <Form noValidate onSubmit={handleSubmit}>
                  ...
                  <Row className="mb-3">
                    ...
                    >
                      ...
                      >
                        ...
                        <option value="main" key="active">
                          Main
                        </option>
                        <option value="sub" key="inactive">
                          Sub
                        </option>
                      </Form.Select>
                      <Form.Control.Feedback type="invalid">
                    ...
                    >
                      ...
                      <Form.Control
                        ...
                        isValid={
                          touched.image &&
                          (imagePreviews || selectedBanner.image.length) &&
                          !errors.image
                        }
                        isInvalid={
                          touched.image &&
              ...
              <Modal.Footer>
                <Button className="btn-success" type="submit">
                  {!selectedBanner.id ? "Create" : "Save"}
                </Button>
                <Button className="btn-danger" onClick={() => closeMainModal()}>
                  Close
                </Button>
              </Modal.Footer>
            </Form>
      ...
      <div className="card card-body">
        <div className="row mb-12">
          ...
          <div className="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
            ...
            >
              <i className="ti ti-shopping-cart text-white me-1 fs-5"></i> Add
              Banner
            </button>
          </div>
        </div>
              ...
              <tbody>
                {filteredBanners.map((banner, i) => (
                  <tr className="search-items" key={i}>
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-3">
                          <div className="user-meta-info">
                            <h6
                              className="user-name mb-0 capitalize"
                    ...
                    <td className="capitalize">{banner.type || "-"}</td>
